                ...
                <div class="row shadow rounded pb-3 ">
                    <h3 class="bg-c-orange col-md-12 text-white rounded-top text-center pt-2 pb-2 text-uppercase">Sign Up with us to receive Offers, Promotions, Discounts and News.</h2>
                        ...
                        <div class="form-group col-md-9">
                            ...
                            <label for="mce-FNAME">Name: <span class="text-danger">*</span>
                            </label>
                            <!-- label -->
                        ...
                        <label for="mce-MMERGE2">Birthday Month </label>
                            <!-- label -->
                            ...
                            <div class="input-group">
                                ...
                                <!-- input -->
                                <select name="MMERGE2" class="form-control select2  " id="mce-MMERGE2">
                                        <option value=""></option>
                        ...
                        <div class="row mx-auto">
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- input -->
                                    <input type="number" name="PHONE" class="form-control" value="" id="mce-PHONE" placeholder="">
                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div class="input-group">
                                    ...
                                    <!-- input -->
                                    <input type="number" value="" name="MMERGE6" class="form-control" id="mce-MMERGE6" placeholder="">
